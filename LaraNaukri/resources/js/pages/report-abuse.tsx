    ...
    return (
        <AppLayout page="">
            <div className="flex flex-col items-center justify-center bg-green-50 py-10">
                <h1 className="font-montserrat text-3xl font-bold">Report Abuse</h1>
            </div>
            <section className="mx-auto flex size-10/12 justify-between gap-7">
                <div className="my-7 size-8/12 rounded-xl bg-green-50 p-7">
                    <h1 className="font-montserrat text-lg font-bold">Report Abuse</h1>
                    <form action="" className="my-7">
                        ...
                        <Button className="my-5 w-full cursor-pointer py-5 font-montserrat text-lg font-bold text-white">Report</Button>
                    </form>
                </div>
