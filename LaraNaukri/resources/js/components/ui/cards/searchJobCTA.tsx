export default function SearchJobCTA() {
    return (
        <div
            id="searchjobctr"
            className="group flex w-full cursor-pointer justify-between rounded-lg border bg-gray-300/50 px-5 py-6 transition-colors delay-75 duration-500 hover:bg-white"
        >
            <div>
